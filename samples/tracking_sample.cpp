...
void help(const char *argv0)
{
    std::cout <<
        ...
        "$ ./bin/tracking_sample MedianFlow ../dataset/car.mp4\n\n"
        "$ ./bin/tracking_sample MedianFlow ../dataset/car.mp4 142,125,232,164\n\n"
        "$ ./bin/tracking_sample MedianFlow ../dataset/car.mp4 ../dataset/car.txt\n\n"
              << std::endl;
}
